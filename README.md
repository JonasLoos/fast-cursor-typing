...
[fast-cursor-typing.webm](https://github.com/user-attachments/assets/85418f77-db8c-4da6-9654-7340947acec4)
...
*   **Configurable Character Set**: Define the exact set of characters available for typing via the "Options" section. The system requires 4<sup>3</sup> = 64 characters; if fewer are provided, the remaining slots are padded with spaces. It also supports backspace (`\b`), newline (`\n`), tab (`\t`), and escaped backslash (`\\`).
